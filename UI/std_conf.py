...
class Ui_std_conf(object):
    def setupUi(self, std_conf):
        ...
        self.schoolNameLabel.setGeometry(QtCore.QRect(50, 170, 141, 21))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        ...
        self.colums_count_label.setGeometry(QtCore.QRect(50, 250, 111, 21))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        self.colums_count_label.setFont(font)
        self.colums_count_label.setObjectName("colums_count_label")
        self.colums_count_spin_box = QtWidgets.QSpinBox(std_conf)
        self.colums_count_spin_box.setGeometry(QtCore.QRect(240, 250, 111, 22))
        ...
        self.line.setGeometry(QtCore.QRect(60, 300, 281, 20))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.next_button = QtWidgets.QPushButton(std_conf)
        self.next_button.setGeometry(QtCore.QRect(270, 330, 75, 23))
        self.next_button.setObjectName("next_button")
        self.schoolNameEdit = QtWidgets.QLineEdit(std_conf)
        self.schoolNameEdit.setGeometry(QtCore.QRect(210, 170, 141, 20))
        self.schoolNameEdit.setObjectName("schoolNameEdit")
        self.myoaEdit = QtWidgets.QSpinBox(std_conf)
        self.myoaEdit.setGeometry(QtCore.QRect(240, 210, 111, 22))
        self.myoaEdit.setMaximum(15)
        self.myoaEdit.setObjectName("myoaEdit")
        self.myoaLabel = QtWidgets.QLabel(std_conf)
        self.myoaLabel.setGeometry(QtCore.QRect(50, 210, 161, 21))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        self.myoaLabel.setFont(font)
        self.myoaLabel.setObjectName("myoaLabel")
    ...
    def retranslateUi(self, std_conf):
        ...
        self.myoaLabel.setText(_translate("std_conf", "Maximal year of apprenticeship"))
